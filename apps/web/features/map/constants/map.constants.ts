...
export const NODE_TYPES = {
  intersection: {
    key: "intersection",
    label: "Interseção",
    description: "Cruzamento onde 3+ ruas se encontram",
  ...
  highestElevation: {
    ...
    description: "Nó de interseção com a maior elevação da área",
  ...
  lowestElevation: {
    key: "lowestElevation",
    label: "Menor Elevação",
    description: "Nó de interseção com a menor elevação da área",
...
export const NODE_STYLES: Record<string, NodeStyleEntry> = {
  ...
  intersection: {
    color: NODE_TYPES.intersection.color,
    radius: NODE_TYPES.intersection.radius,
    fillOpacity: NODE_TYPES.intersection.fillOpacity,
  },
  highestElevation: {
    color: NODE_TYPES.highestElevation.color,
    radius: NODE_TYPES.highestElevation.radius,
    fillOpacity: NODE_TYPES.highestElevation.fillOpacity,
  },
  lowestElevation: {
    color: NODE_TYPES.lowestElevation.color,
    radius: NODE_TYPES.lowestElevation.radius,
    fillOpacity: NODE_TYPES.lowestElevation.fillOpacity,
  },
  selected: {
